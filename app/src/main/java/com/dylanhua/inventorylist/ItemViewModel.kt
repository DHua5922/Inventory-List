    ...
    fun sort(sortMethod : MenuItem, listName: String) : List<Item> {
        ...
        when (sortMethod.itemId) {
            ...
            R.id.option_sort_amount_increase -> {
                ...
                Utility.printStyledMessage(
                    app,
                    "List sorted from lowest to highest amount"
                )
            }
            R.id.option_sort_amount_decrease -> {
                ...
                Utility.printStyledMessage(
                    app,
                    "List sorted from highest to lowest amount"
                )
            }
            ...
            R.id.option_amount_leftover_increase -> {
                ...
                Utility.printStyledMessage(
                    app,
                    "Leftover items sorted from lowest to highest amount"
                )
            }
            R.id.option_sort_amount_leftover_decrease -> {
                ...
                Utility.printStyledMessage(
                    app,
                    "Leftover items sorted from highest to lowest amount"
                )
            }
            R.id.option_sort_amount_full_increase -> {
                ...
                Utility.printStyledMessage(
                    app,
                    "Full (checked) items sorted from lowest to highest amount"
                )
            }
            R.id.option_sort_amount_full_decrease -> {
                ...
                Utility.printStyledMessage(
                    app,
                    "Full (checked) items sorted from highest to lowest amount"
                )
            }
            // invalid sort method
            else -> {
